...
<div class="max-w-sm w-full">
  ...
  <div class="bg-red-950 border border-red-800 text-red-300 text-sm rounded-xl px-4 py-3 mb-5"><?php echo e(session('error')); ?></div>
  <?php endif; ?>

  <div class="sa-card p-6" style="background: #111113; border: 1px solid #27272a; border-radius: 12px;">
    <form method="POST" action="<?php echo e(route('superadmin.login.submit')); ?>" class="space-y-4">
      <?php echo csrf_field(); ?>

      <div>
        <label class="block text-xs font-semibold text-zinc-400 mb-1.5 uppercase tracking-wide">Email</label>
        <input type="email" name="email" value="<?php echo e(old('email')); ?>" required autofocus placeholder="admin@wholesalemanager.com">
      </div>
...
<?php /**PATH C:\lovehills\404 manager 1\resources\views/superadmin/login.blade.php ENDPATH**/ ?>