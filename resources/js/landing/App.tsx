...
export default function App() {
  ...
  const navigateTo = (newView: typeof view) => {
    // Redirect to Laravel routes for login and register
    if (newView === 'login') {
    ...
    if (newView === 'register') {
      ...
      const selectedPlan = sessionStorage.getItem('selected_plan_id');
      if (selectedPlan) {
        window.location.href = `/register-workspace?plan=${selectedPlan}`;
      } else {
    ...
    >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full grid lg:grid-cols-2 gap-16 items-center relative z-10">
          ...
          >
            ...
            <p className="text-xl text-slate-600 max-w-lg mb-12 leading-relaxed font-medium">
              Stop juggling spreadsheets. BinoManager is your complete wholesale & retail 
              management system. Track inventory with FIFO precision, manage customer credit, 
              and grow with real-time insights.
            </p>
          ...
          <div className="grid lg:grid-cols-2 gap-24 items-center">
            <div className="relative z-10">
              ...
              <h2 className="text-5xl md:text-7xl font-black text-slate-900 mb-8 tracking-tight leading-[1.1]">
                Your business, <br />
                <span className="text-indigo-600 italic">anywhere.</span>
              </h2>
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-amber-50 border border-amber-200 text-amber-700 text-xs font-black uppercase tracking-widest mb-6">
                <Clock className="w-3 h-3" />
                Mobile Apps Coming Soon
              </div>
              <p className="text-slate-600 text-xl font-medium leading-relaxed mb-12 max-w-lg">
                Access your business from any device with our mobile-responsive web interface. 
                Native iOS and Android apps launching soon. Manage sales, check inventory, and track performance on the go.
              </p>
              
              <div className="space-y-8">
                {[
                  { icon: <Zap className="w-6 h-6" />, title: "Real-Time Cloud Sync", desc: "Changes sync instantly across all your devices via the cloud." },
                  { icon: <ShieldCheck className="w-6 h-6" />, title: "Two-Factor Authentication", desc: "Keep your business data secure with 2FA and encrypted connections." },
                  { icon: <Globe className="w-6 h-6" />, title: "Mobile-Responsive Design", desc: "Full-featured web interface optimized for tablets and smartphones." }
                ].map((item, i) => (
                  <motion.div 
                    key={i}
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-20">
            ...
            >
              ...
              <span className="text-xs font-black text-indigo-600 uppercase tracking-widest">Built For Your Business</span>
            </motion.div>
            <h2 className="text-5xl md:text-7xl font-black text-slate-900 mb-8 tracking-tight leading-none">
              Perfect for <span className="text-indigo-600">wholesale</span> <br /> and <span className="text-indigo-600">retail</span> businesses.
            </h2>
            <p className="text-slate-600 max-w-2xl mx-auto text-xl font-medium leading-relaxed">
              Whether you're selling products, managing inventory, or tracking customer credit, 
              BinoManager adapts to your business model.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              { 
                ...
                title: "Retail Stores", 
                examples: "Fashion boutiques, electronics shops, bookstores, phone accessory stores",
                color: "bg-indigo-50 text-indigo-600 border-indigo-100"
              },
              { 
                icon: <Package className="w-8 h-8" />, 
                title: "Wholesale Distributors", 
                examples: "FMCG distributors, bulk suppliers, importers, warehouse operations",
                color: "bg-emerald-50 text-emerald-600 border-emerald-100"
              },
              { 
                icon: <Banknote className="w-8 h-8" />, 
                title: "Food & Beverage", 
                examples: "Bakeries, restaurants, cafes, supermarkets, provision stores",
                color: "bg-amber-50 text-amber-600 border-amber-100"
              },
              { 
                icon: <ShieldCheck className="w-8 h-8" />, 
                title: "Pharmacies & Healthcare", 
                examples: "Pharmacies, drug stores, medical supply stores, health clinics",
                color: "bg-purple-50 text-purple-600 border-purple-100"
              },
              { 
                icon: <TrendingUp className="w-8 h-8" />, 
                title: "E-commerce Sellers", 
                examples: "Online stores, dropshippers, marketplace vendors, social media sellers",
                color: "bg-blue-50 text-blue-600 border-blue-100"
              },
              { 
                icon: <LayoutDashboard className="w-8 h-8" />, 
                title: "Multi-Location Chains", 
                examples: "Franchise owners, multiple outlets, branch operations",
              ...
              <motion.div 
                ...
                viewport={{ once: true }}
                transition={{ delay: i * 0.1 }}
                className="p-8 rounded-[2rem] bg-white border border-slate-100 shadow-sm hover:shadow-xl transition-all duration-500 group relative overflow-hidden"
              >
                <div className="absolute -bottom-8 -right-8 w-32 h-32 bg-slate-50 rounded-full group-hover:scale-150 transition-transform duration-700 -z-10" />
                <div className={cn("w-14 h-14 rounded-2xl border flex items-center justify-center mb-6 transition-all duration-500 group-hover:scale-110 group-hover:rotate-6", business.color)}>
                  {business.icon}
                </div>
                <h3 className="text-xl font-black text-slate-900 mb-3 leading-tight">{business.title}</h3>
                <p className="text-slate-500 text-sm font-medium leading-relaxed">{business.examples}</p>
              </motion.div>
            ))}
          </div>
          ...
          <div className="mt-20 text-center">
            <p className="text-slate-600 text-lg font-medium mb-8">
              Not sure if BinoManager is right for your business?
            </p>
            <button 
              onClick={onGetStarted}
              className="px-10 py-5 bg-indigo-600 text-white rounded-2xl text-lg font-black hover:bg-indigo-700 transition-all shadow-xl shadow-indigo-200 active:scale-95"
            >
      ...
      <section className="py-40 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto relative">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-12">
          {[
            { icon: <LayoutDashboard className="w-8 h-8" />, title: "Real-Time Dashboard", desc: "Monitor sales, inventory, and profit/loss in real-time from a unified command center.", color: "indigo" },
            { icon: <Package className="w-8 h-8" />, title: "FIFO Inventory Tracking", desc: "First-In-First-Out stock management prevents overselling and maintains accurate valuation.", color: "emerald" },
            { icon: <BarChart3 className="w-8 h-8" />, title: "Profit & Loss Analytics", desc: "Track cost price vs selling price with detailed financial reports and charts.", color: "purple" },
            { icon: <Users className="w-8 h-8" />, title: "Customer Credit Management", desc: "Manage customer accounts, track payments, and monitor outstanding balances.", color: "blue" },
            { icon: <CreditCard className="w-8 h-8" />, title: "Multi-User Collaboration", desc: "Add team members with role-based permissions (Admin vs Sales users).", color: "rose" },
            { icon: <Zap className="w-8 h-8" />, title: "Thermal Receipt Printing", desc: "Generate professional 80mm POS receipts for every sale with your branding.", color: "amber" }
          ].map((feature, i) => (
            <motion.div key={i}>
              <FeatureCard 
                icon={feature.icon}
          ...
          <div className="grid lg:grid-cols-2 gap-32 items-center">
            <div>
              ...
              <div className="space-y-12">
                {[
                  { step: "01", title: "Claim your workspace", desc: "Get your professional business workspace at binomanager.com/yourbusiness in seconds. Each workspace is completely isolated and secure." },
                  { step: "02", title: "Add your inventory", desc: "Import products with barcode support, set cost and selling prices, and track stock levels with automatic FIFO deduction." },
                  { step: "03", title: "Process sales with confidence", desc: "Our database locking system prevents overselling during concurrent transactions. Track which team member made each sale." }
                ].map((item, i) => (
                  <motion.div 
                    key={i} 
                    initial={{ opacity: 0, y: 20 }}
      ...
      <section className="py-40 bg-white relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { name: "Sarah Jenkins", role: "Bakery Owner", quote: "BinoManager transformed how I track my daily sales and inventory. The FIFO system keeps my stock accurate!" },
              { name: "Marcus Chen", role: "Tech Retailer", quote: "The organized workspace is professional. My team loves the concurrent sales processing—no more overselling!" },
              { name: "Elena Rodriguez", role: "Boutique Manager", quote: "Customer credit tracking used to be a nightmare. Now I can see who owes what at a glance." }
            ].map((t, i) => (
              <motion.div 
                key={i}
                initial={{ opacity: 0, y: 20 }}
      ...
      <div className="pt-24 md:pt-40 pb-24 md:pb-40 px-4 max-w-7xl mx-auto relative">
        ...
        <div className="text-center mb-32 relative">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl lg:text-[140px] font-black text-slate-950 tracking-[-0.06em] mb-10 leading-[0.8]">
              Built for <br />
        ...
        <div className="grid grid-cols-1 md:grid-cols-6 gap-6 mb-32">
          ...
          >
            ...
            <div className="relative z-10 h-full flex flex-col">
              ...
              <p className="text-xl text-slate-400 font-medium leading-relaxed max-w-md mb-12">
                Monitor sales, inventory, and profit/loss in real-time. Track daily revenue, low stock alerts, and team performance from one unified command center.
              </p>
              <div className="mt-auto">
                <img 
                  src="/binomanager (2)/dash.png" 
          ...
          >
            ...
            <h3 className="text-2xl font-black text-slate-900 mb-4">Thermal Receipt Printing</h3>
            <p className="text-slate-600 font-medium leading-relaxed">
              Generate professional 80mm POS receipts for every sale with your business branding.
            </p>
          </motion.div>
          ...
          >
            ...
            <h3 className="text-2xl font-black text-slate-900 mb-4">FIFO Inventory Tracking</h3>
            <p className="text-slate-600 font-medium leading-relaxed">
              First-In-First-Out stock management prevents overselling and maintains accurate inventory valuation.
            </p>
          </motion.div>
          ...
          >
            <div className="flex-1">
              ...
              <h3 className="text-3xl font-black text-slate-900 mb-6">Customer Credit Management</h3>
              <p className="text-lg text-slate-600 font-medium leading-relaxed">
                Track customer accounts, manage credit sales, record payments, and monitor outstanding balances with ease.
              </p>
            </div>
          ...
          <div className="grid lg:grid-cols-2 gap-24 items-center">
            ...
            >
              ...
              <h2 className="text-4xl md:text-6xl font-black text-slate-950 mb-6 leading-[0.9]">
                Concurrent Sales <br />
                <span className="text-indigo-600 italic">Processing.</span>
              </h2>
              <p className="text-lg text-slate-600 font-medium leading-relaxed mb-10">
                Multiple team members can process sales simultaneously without overselling. Our database locking system 
                ensures accurate stock levels even during peak hours.
              </p>
              <ul className="space-y-4">
                {[
                  "Database row-level locking prevents race conditions",
                  "Track which team member made each sale",
                  "Role-based access (Admin vs Sales users)",
            ...
            >
              ...
              <img 
                ...
                alt="Concurrent Sales Illustration" 
    ...
    >
      <div className="pt-24 md:pt-40 pb-24 md:pb-40 px-4 max-w-7xl mx-auto relative">
        ...
        <div className="relative space-y-32">
          ...
          {[
            { step: "01", title: "Claim Your Territory", desc: "Sign up in seconds and secure your unique business workspace. This is your digital command center, accessible from anywhere in the world.", icon: <Globe className="w-12 h-12" />, color: "indigo" },
...
function PricingPage({ onBack, onNavigate, onGetStarted }: { onBack: () => void, onNavigate: (v: any) => void, onGetStarted: () => void, key?: string }) {
  ...
  const plans = [
    { 
      name: "Starter", 
      price: billingCycle === 'monthly' ? "5,000" : "4,167", 
      desc: "Perfect for solo entrepreneurs starting out.", 
      features: [
        "1 user account",
        "Up to 50 products",
    ...
    { 
      name: "Business", 
      price: billingCycle === 'monthly' ? "15,000" : "12,500", 
    ...
    { 
      name: "Enterprise", 
      price: billingCycle === 'monthly' ? "35,000" : "29,167", 
      desc: "For businesses that need maximum power.", 
      features: [
        "Unlimited users",
        "Unlimited products",
    ...
    >
      <div className="pt-24 md:pt-40 pb-24 md:pb-40 px-4 max-w-7xl mx-auto relative">
        ...
        <div className="grid lg:grid-cols-3 gap-8 lg:gap-12 mb-40">
          {plans.map((plan, i) => (
            ...
            >
              ...
              <button 
                onClick={() => {
                  // Store plan info in sessionStorage before redirecting
                  sessionStorage.setItem('selected_plan_id', plan.name.toLowerCase());
            ...
            <table className="w-full text-left min-w-[600px]">
              <thead>
                <tr className="border-b border-slate-200">
                  ...
                  <th className="py-4 md:py-6 text-lg md:text-xl font-black text-slate-900 text-center">Business</th>
                  <th className="py-4 md:py-6 text-lg md:text-xl font-black text-slate-900 text-center">Enterprise</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-slate-100">
                {[
                  { name: "Product Limit", s: "50", p: "Unlimited", e: "Unlimited" },
                  { name: "User Accounts", s: "1", p: "Up to 5", e: "Unlimited" },
                  { name: "Customer Credit", s: "—", p: "✓", e: "✓" },
                  { name: "Analytics", s: "Basic", p: "Full P&L", e: "Advanced" },
                  { name: "Support", s: "Email", p: "Email", e: "Priority" }
                ].map((row, i) => (
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-4">
            {[
              { q: "Can I change plans later?", a: "Yes, you can upgrade or downgrade your plan at any time from your billing settings. Changes take effect immediately and we'll prorate the difference." },
              { q: "Is there a free trial?", a: "Yes! All new workspaces get a 14-day free trial with full access to Business plan features. No credit card required to start." },
              { q: "What happens when I reach my product limit?", a: "On the Starter plan (50 products), you'll be prompted to upgrade to Business for unlimited products. You can upgrade anytime." },
              { q: "Do you offer custom enterprise pricing?", a: "Yes. For businesses with unique needs or multiple locations, contact our sales team for a custom quote with volume discounts." }
            ].map((faq, i) => (
    ...
    >
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
        {[
          ...
          { name: "Marcus Chen", role: "Tech Retailer", quote: "The organized workspace is a game changer. My team knows exactly where to find everything, and our efficiency has doubled." },
